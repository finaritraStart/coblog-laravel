    ...
    <div class="log-card">
        <form method="POST" action="{{ route('register') }}">
            ...
            <div align="center" class="card-header">
                <img src="" width="70">
                <span class="login-title">{{ __('Register') }}</span>
                <span class="login-subtitle">nouveau compte</span>

                <input id="name" type="text" placeholder="votre nom" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                @error('name')
                ...
                <input id="email" type="email" placeholder="votre adresse mail" name="email" value="{{ old('email') }}" required autocomplete="email">
                @error('email')
                <p class="text-red-500 text-xs italic mt-4">
                    {{ $message }}
                </p>
